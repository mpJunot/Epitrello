...
import { MoreHorizontal, Share2, Star, Settings, Tag, Sticker, Activity, Archive, EyeIcon, Copy, Mail, LogOut } from 'lucide-react';
...
export function BoardMenu({ board, members, lists, onBoardUpdate }: BoardMenuProps) {
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-80 border-accent">
          ...
          <div className="px-2 py-1.5">
            ...
            <DropdownMenuItem className="flex items-center gap-2" onClick={() => setShowAboutDialog(true)}>
            ...
            <DropdownMenuItem className="flex items-center gap-2" onClick={handlePrintExportShare}>
              <Share2 className="w-4 h-4" />
              <span>Print, export, and share</span>
            </DropdownMenuItem>
            <DropdownMenuItem className="flex items-center gap-2" onClick={handleStar}>
          ...
          <div className="px-2 py-1.5">
            ...
            <DropdownMenuItem className="flex items-center gap-2" onClick={() => setShowBackgroundDialog(true)}>
          ...
          {/* Tools */}
          <div className="px-2 py-1.5">
            <DropdownMenuItem className="flex items-center gap-2" onClick={() => setShowLabelsDialog(true)}>
            ...
            <DropdownMenuItem className="flex items-center gap-2" onClick={() => setShowArchivedDialog(true)}>
              <Archive className="w-4 h-4" />
              <span>Archived items</span>
            </DropdownMenuItem>
            <DropdownMenuItem className="flex items-center gap-2" onClick={handleWatch}>
          ...
          {/* Actions */}
          <div className="px-2 py-1.5">
            <DropdownMenuItem className="flex items-center gap-2" onClick={() => setShowCopyDialog(true)}>
              <Copy className="w-4 h-4" />
              <span>Copy board</span>
            </DropdownMenuItem>
            <DropdownMenuItem className="flex items-center gap-2" onClick={() => setShowEmailDialog(true)}>
              <Mail className="w-4 h-4" />
              <span>Email-to-board</span>
            </DropdownMenuItem>
            <DropdownMenuItem className="flex items-center gap-2 text-red-600" onClick={handleLeaveBoard}>
      ...
      <Dialog open={showCopyDialog} onOpenChange={setShowCopyDialog}>
        <DialogContent className="sm:max-w-md border-accent">
          <DialogHeader>
            ...
            <DialogDescription>
              Create a copy of this board with all its lists and cards
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button onClick={handleCopyBoard} disabled={copying || !copyBoardTitle.trim()}>
        ...
        <DialogContent className="sm:max-w-md border-accent">
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button onClick={handleEmailToBoard} disabled={sendingEmail || !emailAddress.trim()}>
